...
case class OrderDetailWide(
                                  ...
                                  var original_total_amount:Double =0D ,    //原始金额
                                  var feight_fee:Double=0D,
                                  var final_total_amount: Double =0D ,      //实付总额
                                  var final_detail_amount:Double=0D,        //实付分摊

                                  var if_first_order:String=null,   //null

                                  var province_name:String=null,
                                  var province_area_code:String=null,

                                  var user_age_group:String=null,   //null
                                  var user_gender:String=null,      //null
    ...
    def mergeOrderDetail(orderDetail: OrderDetail): Unit = {
        if (orderDetail != null) {
            ...
            this.category3_name = orderDetail.category3_nam
